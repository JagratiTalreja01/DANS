...
parser.add_argument('--n_threads', type=int, default=8,#18
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='../../Dataset/', #'../../Dataset/',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../Demo',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='DIV2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='Set5',#DIV2K',
...
parser.add_argument('--model', default='nlsn',
                    help='model name')
...
parser.add_argument('--extend', type=str, default='.',
                    help='pre-trained model directory')
parser.add_argument('--n_resblocks', type=int, default= 16, #4,#16, #20,
                    help='number of residual blocks')
parser.add_argument('--n_feats', type=int, default=256, #256,
                    help='number of feature maps')
parser.add_argument('--res_scale', type=float, default=1, #0.1,#1,
...
# Log specifications
parser.add_argument('--save', type=str, default='NLSN_Results',#'test',
